...
static void findlowest(double pricei,double price2, double price3){
if(price1<=price2 && price1<=price3){
System.out.println("\nProduct 1 is of the lowest price1");
}
else if(price2<=price1 && price2<=price3){
System.out.println("\nproduct 2 is of the lowest price1");
}
else{
System.out.println("\nProduct 3 of the lowest price1");
}
}
